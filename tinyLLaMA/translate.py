...
filename = 'tinyLLama-traduzione-mac.csv'
...
# Caricamento del tokenizer e del modello TinyLLaMA
...
# Caricamento del dataset Flores
...
for i in range(len(dataset)):
    ...
    # Generazione della traduzione con TinyLLaMA
    ...
    translated_text = generated_text.split("Inglese:")[1].strip() if "Inglese:" in generated_text else generated_text
    ...
    bleu = calculate_bleu(tgt_text, translated_text)
    hallucination = calculate_hallucination(src_text, translated_text)
